...
const CONTRACTS = {
  ...
  path_practice: {
    id: "staff-path-practice-private-v2",
    version: 2,
    ...
    officialRecord: false,
    disclosure: {
      participation: "Voluntary. You choose whether to read or download a practice path.",
      privacy: "This page does not collect or save your answers or progress. If you saved notes in an earlier version, those notes may still remain in this browser's site data; this page does not show or delete them.",
      purpose: `Self-directed practice, not required training or compliance. ${TRAINING_CREDIT_NOTICE}`,
      viewers:
        "You can read the published path. Anyone with access to a downloaded copy or older notes in this browser may also see them. This page does not send answers to a supervisor or use them to evaluate you.",
      creates: "A blank checklist you can download and use for your own review. This page does not create a saved answer, progress record, or score.",
      officialRecord:
        "This worksheet is not an official record and cannot be used as evidence that you completed a required process.",
      retention: "This page does not save new notes or progress. Downloaded files remain wherever you save them until you delete them. Notes saved by an earlier version may remain in this browser until its site data is cleared.",
    },
  },
  my_work: {
