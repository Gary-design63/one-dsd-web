...
export const EQUITY_FRAMEWORK = {
  ...
  pillars: [
    {
      ...
      workAreas: [{ label: "Leadership and systems change", href: "/areas/leadership_systems_change" }],
      oneDhs: [
        { label: "Understanding DHS", href: "/understanding-dhs" },
    ...
    },
    {
      ...
      workAreas: [{ label: "Workforce equity", href: "/areas/workforce_equity" }],
      oneDhs: [
    ...
    },
    {
      ...
      workAreas: [{ label: "Culture, trust, and repair", href: "/areas/culture_trust_repair" }],
      oneDhs: [
    ...
    },
    {
      ...
      workAreas: [
        { label: "Accessibility and language access", href: "/areas/accessibility_language_access" },
        { label: "Policy, program, and service design", href: "/areas/policy_program_service_design" },
      ],
      oneDhs: [
        { label: "Guided equity analysis walkthrough", href: "/equity-policy/analysis" },
    ...
    },
    {
      ...
      workAreas: [{ label: "Community engagement and co-design", href: "/areas/community_engagement_co_design" }],
      oneDhs: [
        { label: "Minnesota Communities", href: "/minnesota-communities" },
    ...
    },
    {
      ...
      workAreas: [{ label: "Data, research, quality, and measurement", href: "/areas/data_research_quality_measurement" }],
      oneDhs: [
        { label: "Equity Policy dashboard", href: "/equity-policy" },
  ...
  launchPackage: [
    ...
    { name: "Accessibility review checklist", status: "partly_in_program" as ToolStatus, href: "/areas/accessibility_language_access" },
    { name: "Inclusive hiring and job-description checklist", status: "partly_in_program" as ToolStatus, href: "/areas/workforce_equity" },
