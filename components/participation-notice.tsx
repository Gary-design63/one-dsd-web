...
const STAFF_NOTICES: Partial<Record<ParticipationSurface, string[]>> = {
  ...
  path_practice: ["This optional worksheet is for your own practice. Your notes and progress stay on this device until you delete them; anyone using this computer may see them. They are not sent to your supervisor or used to evaluate you.", TRAINING_CREDIT_NOTICE],
